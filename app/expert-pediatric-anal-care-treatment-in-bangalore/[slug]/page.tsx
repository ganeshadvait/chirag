...
export default function PilesConditions() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      faqAnswer:
        "Treatment costs vary depending on the condition and approach. Conservative management is very affordable, while procedures may vary. EMI options through GMoney with zero interest, and transparent pricing. Contact our health advisors at 08065916415 for a personalized cost estimate.",
    },
    {
